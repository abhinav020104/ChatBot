...
const API_KEY =  "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"
function App() {
  const [messages , setMessages] = useState([
    {
      message:"Hello I Am Your Personal Assistant ! How Can I Help You ? ",
      sender:"ChatBot",
    }
  ])
  ...
  return (
    <div className='w-full overflow-y-hidden flex items-center h-screen bg-gradient-to-tl from-blue-900 via-teal-500 to-sky-400'>
      <div className=' relative h-[550px] , w-[500px] mx-auto overflow-y-hidden'>
